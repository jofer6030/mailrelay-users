...
### Caso 1: `level = 30`
Si el usuario a registrar tiene `level = 30`, el request debe contener un objeto con las siguientes propiedades:
...
Si el usuario tiene un `level` diferente de `30`, el request debe contener únicamente las siguientes propiedades:
...
- En el caso de `level = 30`, los campos adicionales son obligatorios para registrar correctamente al usuario.
